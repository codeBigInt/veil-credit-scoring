      ...
      <div className="container px-6 relative z-10 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center justify-items-center">
          <div className="space-y-6 text-center md:text-left">
            <span className="section-label">Cap. 03 · Your Public Proof</span>
            <h2 className="font-black uppercase leading-none tracking-tight" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)' }}>
              Identity Pass
              <br />
              <span style={{ WebkitTextStroke: '2px var(--color-primary)', color: 'transparent' }}>You Control</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-lg mx-auto md:mx-0">
              Veil gives you a public CKB identity pass that apps can check without seeing your raw score. Your credit data stays private on Midnight, while any supported app can verify that your pass is real.
            </p>
            ...
            <div className="overflow-hidden rounded-sm border border-primary/40 bg-card">
              <div className="grid gap-0 sm:grid-cols-[0.92fr_1fr]">
                ...
                >
                  ...
                  <div className="absolute inset-x-5.5 bottom-4">
